...
%       for each row.
%       
predicted_values =  X * all_theta';
% max(predicted_values, [], 2) returns a column vector containing max 
% value of every row in predicted_values and its index.
[maximum , p ] = max (predicted_values , [] , 2 );
